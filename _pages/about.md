...
Currently working in stealth on Evaluation of Video-Generative Models measuring the Visual Intelligence of these World Models.

Previously I finished my PhD at [Heidelberg University](https://www.uni-heidelberg.de/en), [Helmholtz Imaging](https://helmholtz-imaging.de) & the [Division of Medical Image Computing at DKFZ](https://www.dkfz.de/medizinische-bildverarbeitung), supervised by [Prof. Klaus Maier-Hein](https://scholar.google.com/citations?user=oCrBpVMAAAAJ&hl=de) and [Dr. Paul Jaeger](https://pfjaeger.github.io) (now Head of AI at LatentLabs).
...
The most concrete expression of this is **nnActive** — the largest benchmark for Active Learning in 3D biomedical segmentation (~150k A100 GPU hours), built on top of **[nnU-Net](https://github.com/MIC-DKFZ/nnUNet)**, the segmentation framework I helped maintain (8k+ stars, 1,000+ active users worldwide).
